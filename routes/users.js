...
var TweeterUserCollection = require('../models/user');
...
passport.deserializeUser(function(id, done) {
    TweeterUserCollection.findById(id, function(err, user) {
        done(err, user);
    });
});

// Validation for password. The password in the function is what the user entered.
// The user.password is the saved password. It's run when someone needs to log in and check if the password they entered is the same as the one in the database.
...
passport.use('signup', new LocalStrategy(
    ...
    function(req, username, password, myCallback) {
        console.log("0");
        ...
        findOrCreateUser = function(){
            ...
            TweeterUserCollection.findOne({'username':username},function(err, user) {
                ...
                if (user) {
                    ...
                    // create the user
                    var newUser = new TweeterUserCollection();
                    ...
                    newUser.save(function(err) {
                        ...
                        return myCallback(null, newUser);
                    });
                }
            });
        };
